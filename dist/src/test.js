...
cir.add(new components_1.Resistor(1, 100, types_1.UnitType.K));
cir.add(new components_1.VoltageSource(1, 10, types_1.UnitType.None));
cir.add(new components_1.Resistor(2, 1000, types_1.UnitType.None));
